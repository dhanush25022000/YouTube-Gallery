import Vdeo from './component/video'
import sty from './component/main.module.css'

const App = () => {
    const videos = [
        {
          "id": 1,
          "title": "Adventure in the Wilderness temporary",
        ...
        {
          "id": 2,
          "title": "Cooking Masterclass: Italian Cuisine temp",
        ...
        {
          "id": 3,
          "title": "Historical Wonders: Ancient Rome temp",
        ...
        {
          "id": 11,
          "title": "Exploring Wildlife: Safari Adventures temp",
        ...
        {
          "id": 12,
          "title": "Science Explained: The Human Brain temp",
        ...
        {
          "id": 17,
          "title": "Travel Diaries: European Adventures temp",
    ...
    return <div className={sty.main}>
      <h1 className={sty.heading}>Youtube Inspired Gallery</h1>
      <div className={sty.cardContainer}>
          {
              videos.map(vdo => <Vdeo videoData = {vdo}/>)
          }
      </div>
    </div>
}
